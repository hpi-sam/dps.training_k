...
def update_or_create_actions():
    ...
    Action.objects.update_or_create(
        ...
        defaults={
            ...
            "effect_duration": None,  # None means permanent
            "conditions": {
                "required_actions": [[str(ActionIDs.IV_ZUGANG), str(ActionIDs.ZVK)]],
                "prohibitive_actions": None,
                "material": None,
                "num_personnel": 3,
                "lab_devices": None,
    ...
    Action.objects.update_or_create(
        ...
        defaults={
            ...
            "conditions": {
                ...
                "prohibitive_actions": [str(ActionIDs.CPAP_BEATMUNGSGERAET_ANBRINGEN)],
                "material": [
                    [
    ...
    Action.objects.update_or_create(
        ...
        defaults={
            ...
            "results": {
                "produced_material": {str(MaterialIDs.LYOPHILISIERTES_FRISCHPLASMA): 1}
            },
        },
    )
    Action.objects.update_or_create(
    ...
    Action.objects.update_or_create(
        ...
        defaults={
            ...
            "results": {"produced_material": {str(MaterialIDs.FRESH_FROZEN_PLASMA): 1}},
        },
    )
    Action.objects.update_or_create(
