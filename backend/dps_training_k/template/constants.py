...
class ActionIDs:
    ...
    VOLLELEKTROLYT_1000 = UUID("2f1b5a58-57a8-4ba9-bb6d-69d2155cdf4d")
    VOLLELEKTROLYT_500 = UUID("9ed9b301-d4f8-4e81-8e33-f26bbdc24104")
    ...
    ANTIBIOTIKUM = UUID("b1267e2b-c398-4221-b192-13d3a49b8459")
    ...
    DEFI_TRANSKUTANER_PACER = UUID("9d1db5ee-3b28-4c8f-8a89-751f684d8cd6")
    ...
    CPAP_BEATMUNGSGERAET_ANBRINGEN = UUID("a54e27ca-e443-464d-9daf-3483bd959242")
    BLUTDRUCK_MESSEN = UUID("38d8ce9d-8cf8-4f85-9ee8-ae8856bb28d4")
    ...
    BLUTGASEANALYSE = UUID("ce492b24-cf12-42b5-a674-d3c77d463f12")
    ...
    ERYTHROZYTENKONZENTRATE_VORBEREITEN = UUID("f5348595-4ef3-42b2-bdd1-2a37a6791de1")
    ERYTHROZYTENKONZENTRATE_ANWENDEN = UUID("b5f4c015-4152-459f-bdbb-defab91a3d99")
...
class MaterialIDs:
    ERYTHROZYTENKONZENTRAT = UUID("f6576558-c1d3-4548-823b-2c1e2b0636d7")
    ...
    BEATMUNGSGERAET_CPAP = UUID("8d81c791-1f19-4b98-8bb0-74c2a7d7afb5")
    ...
    DEFI_TRANSKUTANER_PACER = UUID("04443b9e-ac7d-4145-964c-7a495c9efcef")
